...
//  GameOfLife
//
//  Created by Aayush Bhandari on 7/2/14.
...
{
    // get the row and column that was touched, return the Creature instide the corresponding cell
...
- (void)countNeighbors
{
    ...
    {
        // iterate through all the columns fo a given row
